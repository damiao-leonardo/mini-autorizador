...
public class TransactionController {
    ...
    public ResponseEntity<String> processTransaction(
        ...
        log.info("Recebida requisição para processar transação: numeroCartao={}, valor={}", transactionDto.getNumeroCartao(), transactionDto.getValor());
        String resultado = transactionService.processTransaction(transactionDto);
        log.info("Transação processada com retorno: numeroCartao={}, resultado={}", transactionDto.getNumeroCartao(), resultado);
